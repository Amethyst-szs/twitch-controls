...
public:
    ...
    uint8_t findUnlockShineNumCurrentWorld(bool*) const;
    ...
    int getMainScenarioNoCurrent(void) const;
    ...
    sead::PtrArray<UniqObjInfo> mUniqueInfo; // 0x5C8 (buf size is 0x100, also may not be a ptrarray)
    undefined padding_6A8[0xD0];
    GameProgressData* mProgressData; // 0x6A8
    undefined padding_9F0[0x340];
    int mCurWorldID; // 0x9F0
    undefined filler[0x170];
};
