...
var IrcClient = /** @class */ (function (_super) {
    ...
    function IrcClient(options) {
         ...
         * @eventListener
         */
        _this.onPasswordError = _this.registerEvent();
        /**
         * @eventListener
         */
        ...
        _this._logger = logger_1.createLogger(tslib_1.__assign({ name: 'ircv3', emoji: true }, logger));
        ...
        if (reconnect) {
            _this._connection = new connection_1.PersistentConnection(ConnectionType, connectionOptions, { logger: _this._logger }, options.connectionOptions);
        }
        else {
            _this._connection = new ConnectionType(connectionOptions, _this._logger, options.connectionOptions);
        }
        try {
            for (var _f = tslib_1.__values(Object.values(CoreCapabilities)), _g = _f.next(); !_g.done; _g = _f.next()) {
                var cap = _g.value;
        ...
        if (channels) {
            _this.addInternalListener(_this.onRegister, function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (resolvedChannels) {
                                try {
                                    for (resolvedChannels_1 = tslib_1.__values(resolvedChannels), resolvedChannels_1_1 = resolvedChannels_1.next(); !resolvedChannels_1_1.done; resolvedChannels_1_1 = resolvedChannels_1.next()) {
        ...
        _this.onTypedMessage(Commands_1.CapabilityNegotiation, function (_a) {
                ...
                return tslib_1.__generator(this, function (_j) {
                    switch (_j.label) {
                        ...
                        case 1:
                            ...
                            capList = shared_utils_1.arrayToObject(caps, function (part) {
                                var _a;
                                if (!part) {
                                    return {};
                                }
                            ...
                            try {
                                for (_d = tslib_1.__values(Object.entries(capList)), _e = _d.next(); !_e.done; _e = _d.next()) {
                        ...
                        case 3:
                            {
                                ...
                                try {
                                    for (caps_1 = tslib_1.__values(caps), caps_1_1 = caps_1.next(); !caps_1_1.done; caps_1_1 = caps_1.next()) {
                                        cap = caps_1_1.value;
        ...
        _this.onTypedMessage(Commands_1.Ping, function (_a) {
            var message = _a.params.message;
            _this.sendMessage(Commands_1.Pong, { message: message });
        });
        _this.onTypedMessage(Numerics_1.Reply001Welcome, function (_a) {
            var me = _a.params.me;
            return _this._handleReceivedClientNick(me);
        });
        _this.onTypedMessage(Numerics_1.Reply004ServerInfo, function (_a) {
            var userModes = _a.params.userModes;
            if (userModes) {
                _this._serverProperties.supportedUserModes = userModes;
            }
        });
        _this.onTypedMessage(Numerics_1.Reply005Isupport, function (_a) {
            ...
            _this._supportedFeatures = tslib_1.__assign(tslib_1.__assign({}, _this._supportedFeatures), newFeatures);
        });
        _this.onTypedMessage(Numerics_1.Reply376EndOfMotd, function (_a) {
            var me = _a.params.me;
        ...
        _this.onTypedMessage(Numerics_1.Error422NoMotd, function (_a) {
            var me = _a.params.me;
            if (!_this._registered) {
                _this._handleReceivedClientNick(me);
                _this._registered = true;
        ...
        _this.onTypedMessage(Numerics_1.Error462AlreadyRegistered, function (_a) {
            var me = _a.params.me;
        ...
        _this.onTypedMessage(Commands_1.PrivateMessage, function (msg) {
            var _a;
            var _b = msg.params, target = _b.target, content = _b.content;
            var ctcpMessage = StringTools_1.decodeCtcp(content);
            ...
            if (ctcpMessage) {
                ...
                _this.emit(_this.onPrivmsg, target, nick, content, msg);
            }
        });
        _this.onTypedMessage(Commands_1.NickChange, function (msg) {
            var _a;
        ...
        _this.onTypedMessage(Commands_1.Notice, function (msg) {
            var _a;
            var _b = msg.params, target = _b.target, content = _b.content;
            var ctcpMessage = StringTools_1.decodeCtcp(content);
            var nick = (_a = msg.prefix) === null || _a === void 0 ? void 0 : _a.nick;
            ...
            _this.emit(_this.onNotice, target, nick, content, msg);
        });
        _this.addInternalListener(_this.onRegister, function () { return _this._startPingCheckTimer(); });
        _this._credentials = tslib_1.__assign({}, credentials);
        if (channelTypes) {
    ...
    IrcClient.prototype.addCapability = function (cap) {
        ...
        if (cap.messageTypes) {
            try {
                for (var _b = tslib_1.__values(cap.messageTypes), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    IrcClient.prototype.collect = function (originalMessage) {
        ...
        var collector = new (MessageCollector_1.MessageCollector.bind.apply(MessageCollector_1.MessageCollector, tslib_1.__spreadArray([void 0, this, originalMessage], tslib_1.__read(types))))();
    ...
    IrcClient.prototype.quit = function (message) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                this.sendMessage(Commands_1.ClientQuit, { message: message });
    ...
    IrcClient.prototype.say = function (target, message, tags) {
        if (tags === void 0) { tags = {}; }
        this.sendMessage(Commands_1.PrivateMessage, { target: target, content: message }, tags);
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, Promise.all(capabilities
                        ...
                        .map(function (capList) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (capReply.params.subCommand === 'ACK') {
                            ...
                            try {
                                for (newNegotiatedCaps_1 = tslib_1.__values(newNegotiatedCaps), newNegotiatedCaps_1_1 = newNegotiatedCaps_1.next(); !newNegotiatedCaps_1_1.done; newNegotiatedCaps_1_1 = newNegotiatedCaps_1.next()) {
    ...
    IrcClient.prototype._updateCredentials = function (newCredentials) {
        this._credentials = tslib_1.__assign(tslib_1.__assign({}, this._credentials), newCredentials);
    };
    IrcClient.prototype._setupConnection = function () {
        ...
        this._connection.onConnect(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, password, e_7;
            var _this = this;
            var _b, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                this.sendMessageAndCaptureReply(Commands_1.CapabilityNegotiation, {
                                    ...
                                    _this._serverCapabilities = new Map(Object.entries(Object.assign.apply(Object, tslib_1.__spreadArray([{}], tslib_1.__read(capLists)))));
                    ...
                    case 3:
                        e_7 = _d.sent();
                        this.emit(this.onPasswordError, e_7);
                        this.quit().catch(function () {
                            return _this._logger.debug("Error while disconnecting after password error: " + e_7.message);
                        });
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
    ...
    IrcClient.prototype._handleEvents = function (message) {
        ...
        try {
            for (var _b = tslib_1.__values(handlers.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
