...
var Message = /** @class */ (function () {
    ...
    Message.prototype.tagsToString = function () {
        return tslib_1.__spreadArray([], tslib_1.__read(this._tags.entries())).map(function (_a) {
            var _b = tslib_1.__read(_a, 2), key = _b[0], value = _b[1];
            return (value ? key + "=" + escapeTag(value) : key);
        }).join(';');
    };
    Message.prototype.toString = function (includePrefix) {
        var _this = this;
        if (includePrefix === void 0) { includePrefix = false; }
        var cls = this.constructor;
        var specKeys = Object.keys(cls.PARAM_SPEC);
        var fullCommand = tslib_1.__spreadArray([
            this._command
        ], tslib_1.__read(specKeys
    ...
    Object.defineProperty(Message.prototype, "params", {
        get: function () {
            ...
            var cls = this.constructor;
            var specKeys = Object.keys(cls.PARAM_SPEC);
            return Object.assign.apply(Object, tslib_1.__spreadArray([{}], tslib_1.__read(specKeys
                .map(function (paramName) {
                // TS inference does really not help here... so this is any for now
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                var param = _this[paramName];
