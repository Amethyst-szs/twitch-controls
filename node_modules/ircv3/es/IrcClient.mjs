import { __assign, __awaiter, __decorate, __extends, __generator, __read, __spreadArray, __values } from "tslib";
...
var IrcClient = /** @class */ (function (_super) {
    ...
    function IrcClient(options) {
        ...
        _this._logger = createLogger(__assign({ name: 'ircv3', emoji: true }, logger));
        ...
        if (reconnect) {
            _this._connection = new PersistentConnection(ConnectionType, connectionOptions, { logger: _this._logger }, options.connectionOptions);
        }
        else {
        ...
        if (channels) {
            _this.addInternalListener(_this.onRegister, function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.onTypedMessage(PrivateMessage, function (msg) {
            ...
            var ctcpMessage = decodeCtcp(content);
    ...
    IrcClient.prototype.collect = function (originalMessage) {
        ...
        var collector = new (MessageCollector.bind.apply(MessageCollector, __spreadArray([void 0, this, originalMessage], __read(types))))();
    ...
    IrcClient.prototype.say = function (target, message, tags) {
        if (tags === void 0) { tags = {}; }
        this.sendMessage(PrivateMessage, { target: target, content: message }, tags);
    };
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                this.sendMessageAndCaptureReply(CapabilityNegotiation, {
                                    ...
                                    _this._serverCapabilities = new Map(Object.entries(Object.assign.apply(Object, __spreadArray([{}], __read(capLists)))));
