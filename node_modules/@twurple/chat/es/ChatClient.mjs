...
import { HostTarget } from "./caps/twitchCommands/messageTypes/HostTarget.mjs";
 ...
 * @hideProtected
 */
let ChatClient = ChatClient_1 = class ChatClient extends IrcClient {
    /**
    ...
    constructor(config = {}) {
        ...
        this._whisperRateLimiter = new TimedPassthruRateLimiter(new TimeBasedRateLimiter({
    ...
    async host(channel, target) {
        const channelName = toUserName(channel !== null && channel !== void 0 ? channel : this._credentials.nick);
