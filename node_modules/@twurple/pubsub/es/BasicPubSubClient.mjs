...
let BasicPubSubClient = BasicPubSubClient_1 = class BasicPubSubClient extends EventEmitter {
    ...
    constructor(options) {
        ...
        this._connection = new PersistentConnection(WebSocketConnection, { hostName: 'pubsub-edge.twitch.tv', port: 443, secure: true }, { logger: this._logger }, { wsOptions: options === null || options === void 0 ? void 0 : options.wsOptions });
